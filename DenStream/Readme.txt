...
speaking,a big parameter sigma may result in low precision,so you should choose a appropriate sigma.I 
think that sigma between 0.1 to 2 may be a good choice.When you want to generate data,you just need to 
execute the program PointEntrance(sigma);
